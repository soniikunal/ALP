...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Looking to improve claims management efficiency? Explore FBSPL's top-notch insurance outsourcing services. Request a free business audit to get your business processes analyzed and tailored solutions from our experts to meet your unique needs."
    />
    <title>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css" />
    <meta name="keywords" content="insurance agency customer service outsourcing, claims management outsourcing, insurance claims outsourcing, outsource insurance claims processing, Policy processing outsourcing services, claims Management Outsourcing Services, Insurance bpo, bpo in insurance " />
    <!-- Jquey -->
    <script
    ...
    <!-- font -->
    <script
      src="https://kit.fontawesome.com/f93e6dc96d.js"
      crossorigin="anonymous"
    ></script>
    <!-- Bootstrap -->
    <script
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img
            src="<?= $baseurl ?>/assets/images/FBSPL Logo.png"
            alt="FBSPL"
        ...
        <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
          ...
          <button
            class="btn btn-lg btn-primary px-5 d-none d-lg-block"
            type="submit"
        ...
        <div class="d-block d-lg-none">
          <div class="accordion accordion-flush" id="accordionExample">
            <div class="accordion-item my-2 rounded">
              ...
              <div
                id="NewBusiness"
                class="accordion-collapse collapse show serviceSection"
            ...
            <div class="accordion-item my-2 rounded">
              <h2 class="accordion-header">
                <button
                  ...
                  type="button"
                  data-bs-toggle="collapse"
                  data-bs-target="#PolicyProcessing"
                  aria-expanded="false"
            ...
            <div class="accordion-item my-2 rounded">
              <h2 class="accordion-header">
                <button
                  ...
                  type="button"
                  data-bs-toggle="collapse"
                  data-bs-target="#ClaimManagement"
                  aria-expanded="false"
            ...
            <div class="accordion-item my-2 rounded">
              <h2 class="accordion-header">
                <button
                  ...
                  type="button"
                  data-bs-toggle="collapse"
                  data-bs-target="#AccountingSupport"
                  aria-expanded="false"
...
<br/>
  ...
  <!-- Ready to Take Next Step -->
    ...
    <section class="pb-3">
      ...
      <div class="row d-none d-lg-flex justify-content-between">
        ...
        <div class="col-lg-4 d-flex  align-items-center justify-content-center">
          <img
            class="me-3"
            src="<?= $baseurl ?>/assets/images/UNITED KINGDOM.svg"
            alt="ukFlag"
        ...
        <div class="row d-none d-lg-flex">
          ...
          >
            <div class="d-flex text-start">
              <img
                class="me-4"
                src="<?= $baseurl ?>/assets/images/Isolation_Mode.svg"
                alt="isoCertificate"
                width="45px"
              />
          ...
          <div
            class="col-lg-6  py-4 text-white d-flex justify-content-end align-items-center"
          >
            <p class="m-0 fs-14p">
    ...
    <div
      ...
      tabindex="-1"
      aria-labelledby="FreeAgencyAuditLabel"
      aria-hidden="true"
    >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body p-0">
            <div class="d-flex justify-content-center row">
              <div class="col-lg-6 px-0 col-sm-12 d-none d-xl-block" 
              style="background-color: #080d15;"
              >
                <img
                  src="<?= $baseurl ?>/assets/images/aboutUsImag.png"
                  class="float-end w-100"
                  alt="fusionfirst"
                />
              </div>
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="CSSignModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="container">
              <div class="row">
                <div class="col-6 p-0 d-none d-lg-block">
                  <img
                    src="<?= $baseurl ?>/assets/images/CaseStudySIgnModal.png"
                    class="float-end w-100"
                  />
                </div>
                    ...
                    <form class="mt-5">
                      ...
                      <div class="d-flex mt-5 flex-column">
                        <button
                          type="button"
                          id="CSSubmit"
                          onclick="SubmitCaseStudyForm(this)"
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="CSSThankYouLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body p-0 overflow-hidden">
              ...
              <div class="row">
                <div class="col-lg-7 col-sm-12 d-flex">
                  <div class="m-auto ps-5">
                    ...
                    <button class="btn btn-primary px-5 my-3" id="CSTYGoBack"
                    data-bs-dismiss="modal"
                    >
                      Go Back
                    </button>
                ...
                <div class="col-lg-5 col-sm-12 d-none d-lg-block d-flex p-0">
                  <!-- <div class="my-auto"> -->
                  <img
                    src="<?= $baseurl ?>/assets/images/CSThankYou.png"
                    class="image-fluid float-end"
                    alt=""
                  />
                  <!-- </div> -->
                </div>
            ...
            <div
              class="row d-block d-lg-none position-relative overflow-hidden px-5"
            >
    ...
    <div
      ...
      data-bs-keyboard="false"
      tabindex="-1"
      aria-labelledby="CaseStudyModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body p-0">
            <div class="d-flex flex-column">
              <div class="position-relative">
                <img
                  src="<?= $baseurl ?>/assets/images/caseStudy.png"
                  class="img-fluid w-100"
                  alt="fusionfirst"
                />
                <div
                  class="position-absolute fw-500 fs-1 csHeading d-none d-lg-block"
                  style="top: 143px"
                >
                  <h1>
              ...
              <div class="m-sm-3 m-lg-5">
                ...
                <div id="Quote">
                  <span>
                    ...
                    >
                      <path
                        d="M-5.72205e-05 47L-5.92406e-05 23.8919C-6.07644e-05 6.46213 14.658 -2.72121e-06 14.658 -2.72121e-06L15.8303 1.9584C15.8303 1.9584 7.03566 10.9667 8.59906 19.7791L27.166 19.7791L27.166 47L-5.72205e-05 47Z"
                        fill="#E38B29"
                      />
                    </svg>
                    <svg
              ...
              <button type="button" class="btn btn-lg " id="downloadCaseStudy">Download Full Case Study</button>
                  ...
                  <div class="mt-5 d-flex justify-content-center">
                    <button
                      type="button"
                      class="btn btn-primary btn-lg w-50 d-none d-lg-block"
                      id="downloadCaseStudy"
                      data-bs-dismiss="modal"
    ...
    <button
      class="btn btn-primary w-100 h-100 position-absolute bottom-0"
      data-bs-toggle="modal"
      data-bs-target="#FreeAgencyAudit"
    >
